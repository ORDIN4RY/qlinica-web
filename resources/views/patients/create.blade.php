...
@section('page-subtitle', 'Isi formulir data pasien baru')
...
<div class="max-w-3xl">
  <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
    <div class="px-6 py-4 border-b border-gray-100 flex items-center gap-3">
      ...
      <h3 class="font-semibold text-gray-800">Form Pasien Baru</h3>
    </div>
    ...
    <form method="POST" action="{{ route('patients.store') }}" class="p-6 space-y-5">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
        ...
        <div>
          ...
          <input type="text" name="disease" value="{{ old('disease') }}" required
            ...
            placeholder="Contoh: ISPA, Hipertensi">
        ...
        <div class="sm:col-span-2">
          ...
          <textarea name="address" required rows="2"
            class="w-full px-4 py-2.5 border @error('address') border-red-400 @else border-gray-200 @enderror rounded-xl focus:outline-none focus:border-blue-900 focus:ring-2 focus:ring-blue-900/10 text-sm resize-none"
        ...
        <div class="sm:col-span-2">
          ...
          <textarea name="notes" rows="2"
            class="w-full px-4 py-2.5 border border-gray-200 rounded-xl focus:outline-none focus:border-blue-900 focus:ring-2 focus:ring-blue-900/10 text-sm resize-none"
      ...
      <div class="flex items-center gap-3 pt-2">
        <button type="submit"
          ...
          <i class="fas fa-save mr-1.5"></i> Simpan Pasien
        </button>
