          ...
          <tr class="hover:bg-blue-50/40 transition-colors">
            ...
            <td class="px-5 py-3.5">
              <a href="{{ route('dokter.pasien.show', $pasien->id) }}"
                 class="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-xs font-bold rounded-lg transition flex items-center gap-2 w-max">
                <i class="fas fa-book-medical"></i> Buku Rekam Medis
              </a>
            </td>
          </tr>
